...
namespace Server.Migrations
{
    ...
    [Migration("20230530204534_likedplaylistsrrlationship")]
    partial class likedplaylistsrrlationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.LikedUserPlaylists", b =>
                {
                    ...
                    b.HasKey("LikerId", "PlaylistId");

                    b.HasIndex("PlaylistId");

                    b.ToTable("LikedUserPlaylists");
                });

            modelBuilder.Entity("Server.Models.OwnedUserPlaylists", b =>
                {
                    ...
                    b.HasKey("OwnerId", "PlaylistId");

                    b.HasIndex("PlaylistId");

                    b.ToTable("OwnedPlaylistsUsers");
                });
            ...
            modelBuilder.Entity("Server.Models.LikedUserPlaylists", b =>
                {
                    b.HasOne("Server.Models.User", "Liker")
                        .WithMany("LikedPlaylistsUsers")
                        .HasForeignKey("LikerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Server.Models.Playlist", "LikedPlaylist")
                        .WithMany("LikedPlaylistsUsers")
            ...
            modelBuilder.Entity("Server.Models.OwnedUserPlaylists", b =>
                {
                    b.HasOne("Server.Models.User", "Owner")
                        .WithMany("OwnedPlaylistsUsers")
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Server.Models.Playlist", "OwnedPlaylist")
                        .WithMany("OwnedPlaylistsUsers")
                        .HasForeignKey("PlaylistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OwnedPlaylist");
            ...
            modelBuilder.Entity("Server.Models.Playlist", b =>
                {
                    b.Navigation("LikedPlaylistsUsers");

                    b.Navigation("OwnedPlaylistsUsers");
